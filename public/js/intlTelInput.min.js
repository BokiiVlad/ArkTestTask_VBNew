        ...
        var H = 0,
            ...
            b = class {
                ...
                _init() {
                    ...
                    let t =
                        this.d.allowDropdown && !this.d.showSelectedDialCode;
                            ...
                            ((this._handleKeydownEvent = (n) => {
                                if (
                                    ...
                                    let s =
                                        ...
                                        l = this._6(),
                                        a =
                                            window.intlTelInputUtils.getCoreNumber(
                                                l,
                                                this.s.iso2
                                            ),
                                        p =
                ...
                _z(t) {
                    ...
                    if (
                        ...
                        t
                            ...
                            : ((l = "iti__flag iti__globe"),
                              (a = r.noCountrySelected)),
                            (this.l.className = l),
                ...
                _updateMaxLength() {
                    if (this.d.strictMode && window.intlTelInputUtils)
                        if (this.s.iso2) {
                            ...
                            for (
                                ;
                                window.intlTelInputUtils.isPossibleNumber(
                                    e,
                                    this.s.iso2
                                );
                                ...
                                (i = e), (e += "0");
                            let n = window.intlTelInputUtils.getCoreNumber(
                                i,
                                this.s.iso2
                            );
                ...
                _9() {
                    let t = this._6(),
                        e = window.intlTelInputUtils
                            ? window.intlTelInputUtils.formatNumberAsYouType(
                                  t,
                                  this.s.iso2
                              )
                            : t,
                ...
                getNumberType() {
                    return window.intlTelInputUtils
                        ? window.intlTelInputUtils.getNumberType(
                              this._6(),
                              this.s.iso2
                          )
                        : -99;
